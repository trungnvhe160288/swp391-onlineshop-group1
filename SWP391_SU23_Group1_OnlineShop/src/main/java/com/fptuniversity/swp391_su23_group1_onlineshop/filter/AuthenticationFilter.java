 ...
 */
package com.fptuniversity.swp391_su23_group1_onlineshop.filter;
...
public class AuthenticationFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        boolean isSellerPage = path.startsWith("/seller");
        boolean isMartketingPage = path.startsWith("/marketing");
        if (isAdminPage || isSellerPage || isMartketingPage) {
