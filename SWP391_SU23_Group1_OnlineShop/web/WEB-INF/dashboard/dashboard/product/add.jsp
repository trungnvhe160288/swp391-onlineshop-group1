                                                ...
                                                <fieldset class="wizard-fieldset  d-block">
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            ...
                                                            <input type="text" class="form-control wizard-required" name="productName" value="" placeholder="Enter Product Name..." >
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col">
                                                            <div class="form-line">
                                                                ...
                                                                <input type="text" class="form-control wizard-required" id="price" name="price" value="" placeholder="Enter Product Price..." >
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col">
                                                            <div class="form-line">
                                                                ...
                                                                <input type="text" class="form-control wizard-required" id="percent_discount" name="percent_discount" value="" placeholder="Enter Percent Discount < 1" >
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col">
                                                            <div class="form-line">
                                                                ...
                                                                <input type="text" class="form-control wizard-required" name="quantity" id="quantity" value="" placeholder="Enter Product Quantity" >
                                                                <div class="wizard-form-error"></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col">
                                                            ...
                                                            <div class="form-check form-check-inline ">
                                                                <input class="form-check-input" type="radio" name="actived" id="inlineradio1" value="true" checked>
                                                                <label class="form-check-label" for="inlineradio1"><i data-feather="check" class="text-success"></i></label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="actived" id="inlineradio2" value="false" >
                                                                    ...
                                                                    <c:forEach begin="${0}" end="${colors.size() - 1}" var="i">
                                                                        ...
                                                                        <div class="col-auto">
                                                                            <label class="colorinput">
                                                                                <input name="color" type="checkbox" value="${item.id}" class="colorinput-input"  ${i == 0 ? 'checked' : ''}>
                                                                ...
                                                                <div class="selectgroup selectgroup-pills">
                                                                    ...
                                                                    <c:forEach begin="${0}" end="${sizes.size() - 1}" var="i">
                                                                        ...
                                                                        <label class="selectgroup-item">
                                                                            <input type="checkbox" name="size" value="${item.id}" class="selectgroup-input"  ${i == 0 ? 'checked' : ''}>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="selectgroup w-100">
                                                                    ...
                                                                    <c:forEach begin="${0}" end="${categories.size() - 1}" var="i">
                                                                        ...
                                                                        <label class="selectgroup-item">
                                                                            <input type="radio" name="category" value="${item.id}" class="selectgroup-input-radio" ${i == 0 ? 'checked' : ''}>
                                                                            <span class="selectgroup-button">${item.name}</span>
                                                                        </label>
                                                                    </c:forEach>
                                                                </div>
