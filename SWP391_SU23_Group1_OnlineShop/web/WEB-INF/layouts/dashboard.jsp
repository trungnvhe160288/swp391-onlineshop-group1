<%-- 
    Document   : dashboard
    Created on : 14-06-2023, 21:46:03
    Author     : phanh
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link rel='shortcut icon' type='image/x-icon' href='${pageContext.request.contextPath}/dashboard/assets/img/favicon.ico' />
    </head>
                ...
                <nav class="navbar navbar-expand-lg main-navbar sticky">
                    ...
                    <ul class="navbar-nav navbar-right">
                            ...
                            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                                ...
                                <div class="dropdown-list-content dropdown-list-message">
                                    <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
                                                                             text-white"> <img alt="image" src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-1.png" class="rounded-circle">
                                            ...
                                            <img alt="image" src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-2.png" class="rounded-circle">
                                            ...
                                            <img alt="image" src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-5.png" class="rounded-circle">
                                        </span> <span class="dropdown-item-desc"> <span class="message-user">Jacob
                                                Ryan</span> <span class="time messege-text">Your payment invoice is
                                                generated.</span> <span class="time">12 Min Ago</span>
                                        </span>
                                    </a> <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                                            <img alt="image" src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-4.png" class="rounded-circle">
                                            ...
                                            <img alt="image" src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-3.png" class="rounded-circle">
                        ...
                        <li class="dropdown"><a href="#" data-toggle="dropdown"
                                                class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="${pageContext.request.contextPath}/dashboard/assets/img/user.png"
                ...
                <div class="main-sidebar sidebar-style-2">
                    <aside id="sidebar-wrapper">
                        <div class="sidebar-brand">
                            <a href="index.html"> <img alt="image" src="${pageContext.request.contextPath}/dashboard/assets/img/logo.png" class="header-logo" /> <span
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                    <div class="banner-img">
                                                        <img src="${pageContext.request.contextPath}/dashboard/assets/img/banner/1.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-statistic-4">
                                        <div class="align-items-center justify-content-between">
                                            <div class="row ">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                    <div class="banner-img">
                                                        <img src="${pageContext.request.contextPath}/dashboard/assets/img/banner/2.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-statistic-4">
                                        <div class="align-items-center justify-content-between">
                                            <div class="row ">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                    <div class="banner-img">
                                                        <img src="${pageContext.request.contextPath}/dashboard/assets/img/banner/3.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-statistic-4">
                                        <div class="align-items-center justify-content-between">
                                            <div class="row ">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                    <div class="banner-img">
                                                        <img src="${pageContext.request.contextPath}/dashboard/assets/img/banner/4.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <td class="text-truncate">
                                                        <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-8.png" alt="user" data-toggle="tooltip" title=""
                                                                                                        data-original-title="Wildan Ahdian"></li>
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-9.png" alt="user" data-toggle="tooltip" title=""
                                                                                                        data-original-title="John Deo"></li>
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-10.png" alt="user" data-toggle="tooltip" title=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-truncate">
                                                        <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-1.png" alt="user" data-toggle="tooltip" title=""
                                                                                                        data-original-title="Wildan Ahdian"></li>
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-2.png" alt="user" data-toggle="tooltip" title=""
                                                                                                        data-original-title="John Deo"></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-truncate">
                                                        <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-3.png" alt="user" data-toggle="tooltip" title=""
                                                                                                        data-original-title="Wildan Ahdian"></li>
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-4.png" alt="user" data-toggle="tooltip" title=""
                                                                                                        data-original-title="John Deo"></li>
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-5.png" alt="user" data-toggle="tooltip" title=""
                                                                                                        data-original-title="Sarah Smith"></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-truncate">
                                                        <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-7.png" alt="user" data-toggle="tooltip" title=""
                                                                                                        data-original-title="John Deo"></li>
                                                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                        src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-8.png" alt="user" data-toggle="tooltip" title=""
                                                                                                        data-original-title="Sarah Smith"></li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="support-ticket media pb-1 mb-3">
                                            <img src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-1.png" class="user-img mr-2" alt="">
                                        ...
                                        <div class="support-ticket media pb-1 mb-3">
                                            <img src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-2.png" class="user-img mr-2" alt="">
                                            <div class="media-body ml-3">
                                        ...
                                        <div class="support-ticket media pb-1 mb-3">
                                            <img src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-3.png" class="user-img mr-2" alt="">
                                            <div class="media-body ml-3">
                                        ...
                                        <div class="support-ticket media pb-1 mb-3">
                                            <img src="${pageContext.request.contextPath}/dashboard/assets/img/users/user-6.png" class="user-img mr-2" alt="">
                                            <div class="media-body ml-3">
