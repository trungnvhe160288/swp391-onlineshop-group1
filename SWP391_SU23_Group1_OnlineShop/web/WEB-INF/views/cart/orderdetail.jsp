                                ...
                                <tbody>
                                    <c:forEach items="${data.orderLine}" var="item">
                                        <tr>
                                            ...
                                            <td>${item.quantity}</td>
                                            <td><span class="money" style="background-color: ${dao.getColorById(item.colorID).bgr_hex}; border: 1px solid #000; margin: auto 0.25rem; padding: 0.25rem 0.75rem"></span></td>
